...
#define CUSTOM_MACHINE_NAME "Delta Marcus"
...
#define HOTEND_OFFSET_X { 0.0, 23.00 } // (mm) relative X-offset for each nozzle
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 103.56
  #define DEFAULT_bedKi 20.13
  #define DEFAULT_bedKd 355.24
...
#define DELTA
  ...
  #define DELTA_PRINTABLE_RADIUS 70    // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 217.0        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 284.28             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -1.80, 0.00, -2.65 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 97.05              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.25, -0.23, -0.02 } // Get these values from G33 auto calibrate
...
#define E0_STEPS (XYZ_FULL_STEPS_PER_ROTATION * XYZ_MICROSTEPS / double(E0_MM_PER_ROTATION))

// delta speeds must be the same on xyz
#define DEFAULT_XYZ_STEPS_PER_UNIT ((XYZ_FULL_STEPS_PER_ROTATION) * (XYZ_MICROSTEPS) / double(XYZ_BELT_PITCH) / double(XYZ_PULLEY_TEETH))
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, E0_STEPS }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 1000, 800 }
